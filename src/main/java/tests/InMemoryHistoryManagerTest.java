...
//    }
    ...
    Subtask subtask1;
    Task taskUpdate;
    static UUID uuidTask = UUID.randomUUID();;
    static UUID uuidEpic = UUID.randomUUID();;
    static UUID uuidSubtask = UUID.randomUUID();;
    ...
    void create() { // по три задачи
        ...
        startTimeTestTask1 = LocalDateTime.parse("2014-12-22T05:10:30");
        endTimeTestTask1 = LocalDateTime.parse("2014-12-22T06:00:30");

        startTimeTestEpic1 = LocalDateTime.parse("2015-12-22T08:15:30");
        endTimeTestEpic1 = LocalDateTime.parse("2015-12-22T08:35:30");

        startTimeTestSubtask1 = LocalDateTime.parse("2016-12-22T10:20:30");
        endTimeTestSubtask1 = LocalDateTime.parse("2016-12-22T10:40:30");
...
Process finished with exit code 0
             */
        assertEquals(2, inMemoryHistoryManager.getTasksInHistory().size());
//        clearHistory();
    }
